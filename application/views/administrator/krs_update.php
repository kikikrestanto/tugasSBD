<div class="container-fluid">
    ...
    <form method="post" action="<?php echo base_url('administrator/krs/update_aksi') ?>">
    	...
    	<div class="form-group">
    		...
    		<input type="hidden" name="id_thn_akademi" class="form-control" value="<?php echo $id_thn_akademi; ?>">
    		<input type="hidden" name="id_krs" class="form-control" value="<?php echo $id_krs; ?>">
    		<input type="text" name="thn_akademi_smt" class="form-control" value="<?php echo $thn_akademi_smt. '/' .$semester; ?>" readonly>
    	</div>

    	<div class="form-group">
    		<label>NPM Mahasiswa</label>
    		<input type="text" name="npm" class="form-control" value="<?php echo $npm; ?>" readonly>
    	</div>
