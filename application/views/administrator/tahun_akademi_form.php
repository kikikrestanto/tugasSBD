...
<div class="alert alert-success" role="alert">
        <i class="fas fa-university"></i> Form Input Tahun Akademi
    </div>

    <form method="post" action="<?php echo base_url(
        'administrator/tahun_akademi/tambah_tahun_akademi_aksi'
    ) ?>">
    <div class="form-group">
        <label> Tahun Akademi </label>
        <input type="text" name="tahun_akademi"
        placeholder="Masukkan Tahun Akademi" class="form-control">
