...
class Matakuliah extends CI_Controller{
    ...
    {
        $data['matakuliah'] = $this->matakuliah_model->tampil_data
        ('matakuliah')->result();
    ...
    public function update($id)
    {
        ...
        $data['matakuliah'] = $this->db->query
        ("select * from matakuliah mk, prodi prd where mk.nama_prodi = prd.nama_prodi and mk.kode_matakuliah='$id' ")->result();
        $data['prodi'] = $this->matakuliah_model->tampil_data('prodi')
        ->result();
        $this->load->view('templates_administrator/header');
        $this->load->view('templates_administrator/sidebar');
